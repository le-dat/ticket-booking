# REASON: Centralized asynchronous Redis client management for caching and rate limiting
import logging
...
async def init_redis() -> Redis:
    ...
    if _redis_client is None:
        ...
        try:
            ...
            logger.warning("⚠️ Could not connect to Redis (%s). Rate limiter will operate in fail-open mode.", exc)
